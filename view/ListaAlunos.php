...
$controller->Processo('carragarTabela');
?>
<!doctype html>
<html lang="pt-BR">
  <head>
                ...
                <table class="table table-striped table-bordered table-list table-hover" id="tabela_generica">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a class="btn btn-success" href="../view/EditarAluno.php?id=<?php echo $row['id_usuario'];?>" role="button"><i class="fas fa-pencil-alt"></i></a> <a class="btn btn-danger mx-2" href="../controller/DeleteAluno.php?id=<?php echo $row['id_usuario'];?>" role="button"><i class="fas fa-trash"></i></a></td>
                      <!-- <td></td> -->
                    </tr>
                  </tbody>
                  <?php } ?>
